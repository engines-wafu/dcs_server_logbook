...
# Database path
db_path = '../data/dcssl.db'  # Update with the actual path
...
create_tables_commands = [
    ...
    '''CREATE TABLE IF NOT EXISTS Pilots (
        ...
        pilot_service TEXT CHECK(service IN ('RN', 'Army', 'RAF')),
        pilot_rank TEXT NOT NULL
    );''',
    '''CREATE TABLE IF NOT EXISTS Squadrons (
        squadron_id TEXT PRIMARY KEY,
        squadron_motto TEXT,
        squadron_service TEXT CHECK(service IN ('RN', 'Army', 'RAF')),
    ...
    '''CREATE TABLE IF NOT EXISTS Aircraft (
        ...
        aircraft_state TEXT CHECK(service IN ('S', 'US')),
